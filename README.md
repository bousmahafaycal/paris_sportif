...
Ce logiciel permet de bien tenir un historique des paris sportifs. Je connaissais des amis qui ne comptaient leurs gains dans leur ensemble alors qu'il faut leur enlever la mise de départ. Par ailleurs, ils ont tendance à minimiser l'argent perdu par leurs défaites.  Il faut compter les défaites et les victoires si on veut savoir exactement combien on gagne/perd.  
...
Une version ligne de commande existe également en lançant pari_interface_commande.py à l'aide de la commande suivante :   
`
python3 pari_interface_commande.py
`

### Capture d'écran
![img](http://imgur.com/ng87LXn)
